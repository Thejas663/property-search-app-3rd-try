...
import client5 from "../assets/client2.jpg"
  ...
  return (
    <section className='max-padd-container bg-hero bg-cover bg-no-repeat h-[722px] w-full'>
      <div className='relative top-32 xs:top-48'>
        ...
        <p className='my-5 max-w-[33rem]'>makes finding your dream property easy! Search for houses, apartments, and commercial spaces.</p>
        {}
        ...
        <div className='flex flex-col gap-4 mt-10 mb-4 max-w-64'>
          ...
          <div className='h5 !font-semibold max-w-52'>people succesfully got their dream house</div>
        </div>
